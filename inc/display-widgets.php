...
<div style="height:150px; overflow:auto; border:1px solid #dfdfdf; padding:5px; margin-bottom:5px;">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;">Pages +/-</h4>
    <div class="dw_collapse">
    <?php 
...
<div class="powered-by">
	<p><?php _e( 'Powered by:', 'bookiopro-widget' ); ?><br/>
		<img src="<?php echo BP_PLUGIN_URL; ?>/images/logo-bookiopro-com.png" alt="Powered by BookioPro.com" width="150px"/>
	</p>
</div>
<?php
    }
...
function dw_show_opts(e){
	...
	var id_base = inside.find('input.id_base').val();
	if(id_base.indexOf("bp_widget") >= 0) {
